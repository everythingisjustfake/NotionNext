...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '歡迎光臨我非樂園, 您是路過嗎？,還是您有意參加漫遊夜？,無論如何，這裡沒有會吃人的花ㅋㅋㅋ',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '我非樂園', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '真榮幸，我們又見面了。', // 作者简介
